...
This file tracks the main AI-assisted prompts used while shaping the hackathon frontend.
...
- Add bubble-style discover categories, room filtering by category, and a visible active-room indicator in the left rail.
